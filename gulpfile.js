  ...
  gulp
    ...
    .pipe(
      newer({
        dest: pathBuild,
        ext: '.html',
        extra: [pathFull.njk.templateExtras, pathFull.data.path],
      }),
    )
    .pipe(
      render({
...
gulp.task('img-build', () =>
  gulp.src(pathFull.img.path).pipe(gulp.dest(pathBase.imgBuild)),
)
...
gulp.task('fnt-build', () =>
  gulp.src(pathFull.fonts.path).pipe(gulp.dest(pathBase.fntBuild)),
)
...
gulp.task('css-build', () => gulp.src(pathFull.css.path).pipe(gulp.dest(pathBase.css)))
